...
func init() {
	...
	startCmd.Flags().StringVar(&startCfg.LogPath, "logPath", "./runtime/t_sync.log", "the path of the log file saved")
	...
	startCmd.Flags().StringVar(&startCfg.MonitorLogPath, "monitorLogPath", "./monitor/t_sync.log", "the path of the monitor log file saved")
